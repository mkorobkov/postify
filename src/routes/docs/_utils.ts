...
export async function getDocumentByRequest(request: ServerRequest<Locals>): Promise<Document | undefined> {
...
export function validateDocumentInputOrThrow(document: PostDocumentInput | PutDocumentInput): void | never {
...
export async function createDocumentAndReturn(request: ServerRequest<Locals, PostDocumentInput>): Promise<Document> {
